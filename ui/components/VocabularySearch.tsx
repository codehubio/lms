...
export default function VocabularySearch() {
  ...
  return (
    <form onSubmit={handleSubmit} className="mb-6" suppressHydrationWarning>
      ...
      <div className="flex gap-2">
        <button
          ...
          className="px-6 py-2 bg-teal-700 text-white rounded-lg hover:bg-teal-800 transition font-semibold"
        >
